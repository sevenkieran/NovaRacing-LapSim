function [car] = VU16_car()
    ...
    car.aero_balance_mode = "data"; % "data" or "static"
    ...
    car.ptrain_data_filepath = "Cars/ReferenceEngineData/VU16_powertrain_data.xlsx";
end